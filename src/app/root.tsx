  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Primary Meta Tags */}
        <title>Our Ring Finder - Never Lose Your Oura Ring Again | Bluetooth Tracker App</title>
        <meta name="title" content="Our Ring Finder - Never Lose Your Oura Ring Again | Bluetooth Tracker App" />
        <meta
          name="description"
          content="Lost your Oura Ring? Our Ring Finder uses precise Bluetooth tracking to locate your ring in seconds. 10x more accurate than built-in finder. Download free for iOS"
        />
        <meta
          name="keywords"
          content="Oura Ring finder, lost Oura Ring, find Oura Ring, Bluetooth tracker, ring locator, Oura Ring app, Oura Ring tracker, find lost ring"
        />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://ourringfinder.com/" />
        <meta property="og:title" content="Our Ring Finder - Never Lose Your Oura Ring Again" />
        <meta
          property="og:description"
          content="Lost your Oura Ring? Our Ring Finder uses precise Bluetooth tracking to locate your ring in seconds. 10x more accurate than built-in finder."
        />
        <meta property="og:image" content="https://ucarecdn.com/4cea285a-102d-4f27-8466-0bf7eced35c7/" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:url" content="https://ourringfinder.com/" />
        <meta name="twitter:title" content="Our Ring Finder - Never Lose Your Oura Ring Again" />
        <meta
          name="twitter:description"
          content="Lost your Oura Ring? Our Ring Finder uses precise Bluetooth tracking to locate your ring in seconds. Download free for iOS."
        />
        <meta name="twitter:image" content="https://ucarecdn.com/4cea285a-102d-4f27-8466-0bf7eced35c7/" />

        {/* Apple */}
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
        <meta name="apple-mobile-web-app-title" content="Our Ring Finder" />

        {/* Favicon */}
        <link rel="icon" type="image/png" href="https://ucarecdn.com/4cea285a-102d-4f27-8466-0bf7eced35c7/" />
        <link rel="apple-touch-icon" href="https://ucarecdn.com/4cea285a-102d-4f27-8466-0bf7eced35c7/" />
